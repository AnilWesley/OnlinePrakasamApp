...
import com.news.onlineprakasamapp.activities.SingleInvestigationActivity;
...
public class InvestigationandCrimeFragment extends Fragment {




    public InvestigationandCrimeFragment() {
    ...
    private void getNews() {
        ...
        Call<FullListDetails> call = service.processInvestigationCrime();
                    ...
                    if (fullListDetails.isStatus()) {
                        ...
                        articlesRecycle.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), articlesRecycle, new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                Intent setIntent = new Intent(getActivity(), SingleInvestigationActivity.class);
