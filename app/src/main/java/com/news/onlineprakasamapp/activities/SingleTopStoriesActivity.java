...
public class SingleTopStoriesActivity extends AppCompatActivity {
    ...
    public void getNews() {
        ...
        String url = "http://apnewsnviews.com/onlineprakasam/api/view_top_news_stories/" + news_id;
        ApiInterface service = RetrofitClientInstance.getRetrofitInstance().create(ApiInterface.class);
        Call<SingleNewsDetail> call = service.processSingleTopStories(url);
        ...
        if (item.getItemId() == R.id.share) {
            ...
            try {
                ...
                Task<ShortDynamicLink> shortLinkTask = FirebaseDynamicLinks.getInstance().createDynamicLink()
                        .setLink(Uri.parse("https://apnewsnviews.com/" + infoList.get(0).getId() + "topstories"))// manually
                        ...
                        .addOnCompleteListener(this, task -> {
                            if (task.isSuccessful()) {
                                ...
                                intent.putExtra("title", "topstories");
