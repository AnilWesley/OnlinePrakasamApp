 ...
 **/
 ...
 public  class ConstantValues {
    ...
    public static void shareDeepLink1(Context activity, String str) {
        if (activity != null) {
            Intent intent = ShareCompat.IntentBuilder.from((Activity) activity).setType(TYPE_TEXT_PLAIN).setText(str).setChooserTitle((CharSequence) SHARE).getIntent();
            if (intent.resolveActivity(activity.getPackageManager()) != null) {
                activity.startActivity(intent);
            }
        }
